...
public final class PerformanceListItem_
...
OnViewChangedListener {
    ...
    public static PerformanceListItem a(Context object) {
        object = new PerformanceListItem_((Context)object);
    ...
    public void onFinishInflate() {
        if (!this.a) {
            this.a = true;
            PerformanceListItem_.inflate((Context)this.getContext(), (int)2130903348, (ViewGroup)this);
