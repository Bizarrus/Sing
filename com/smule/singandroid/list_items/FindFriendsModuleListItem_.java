...
public final class FindFriendsModuleListItem_
extends FindFriendsModuleListItem
implements HasViews,
OnViewChangedListener {
    ...
    public static FindFriendsModuleListItem b(Context object) {
        object = new FindFriendsModuleListItem_((Context)object);
    ...
    public void onFinishInflate() {
        if (!this.t) {
            this.t = true;
            FindFriendsModuleListItem_.inflate((Context)this.getContext(), (int)2130903244, (ViewGroup)this);
