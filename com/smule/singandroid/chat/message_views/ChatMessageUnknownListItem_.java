...
public final class ChatMessageUnknownListItem_
extends ChatMessageUnknownListItem
implements HasViews,
OnViewChangedListener {
    ...
    public static ChatMessageUnknownListItem b(Context object) {
        object = new ChatMessageUnknownListItem_((Context)object);
        ...
        if (this.c != null) {
            this.c.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    ChatMessageUnknownListItem_.this.c();
                }
            });
        }
    }
    ...
    public void onFinishInflate() {
        if (!this.p) {
            this.p = true;
            ChatMessageUnknownListItem_.inflate((Context)this.getContext(), (int)2130903116, (ViewGroup)this);
