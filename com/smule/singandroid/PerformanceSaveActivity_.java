...
public final class PerformanceSaveActivity_
extends PerformanceSaveActivity
implements HasViews,
OnViewChangedListener {
    ...
    public void a(@NonNull RunTimePermissionsRequest runTimePermissionsRequest, @Nullable RunTimePermissionsRequester.ResultCallback resultCallback) {
        ...
        PerformanceSaveActivity_.super.a(runTimePermissionsRequest, resultCallback);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.setContentView(2130903349);
    }

    @Override
    public void onSaveInstanceState(Bundle bundle) {
        super.onSaveInstanceState(bundle);
        bundle.putParcelable("mPostSingBundle", (Parcelable)this.g);
    }
